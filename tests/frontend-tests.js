...
class FrontendTester {
    ...
    async setup() {
        ...
        await context.overridePermissions('https://livekit-frontend.livekit-demo.cloudportal.app', [
            'camera',
            'microphone'
        ]);
    }
    ...
    async testFrontendLoading() {
        ...
        try {
            const response = await this.page.goto('https://livekit-frontend.livekit-demo.cloudportal.app', {
