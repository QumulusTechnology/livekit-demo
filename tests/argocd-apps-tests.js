...
class ArgoCDAppsTester {
    ...
    async testKubernetesPods() {
        ...
        try {
            const namespaces = ['argocd', 'grafana', 'harbor', 'livekit', 'meet-client', 'newtrivoh', 'loki', 'mimir', 'minio-operator', 'minio-tenant', 'trivoh-api', 'redis', 'cert-manager', 'ingress-nginx', 'external-secrets-system'];
            const podStatuses = {};
            let totalPods = 0;
            let runningPods = 0;
